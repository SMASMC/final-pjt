<template>
  <section ref="section1"
    ...
    <!-- 안내 텍스트 -->
    <transition v-show="showMainContent" name="fade" appear>
      <div class="absolute bottom-20 font-bold text-gray-500 text-xl text-center w-full animate-bounce cursor-pointer"
    ...
    <div class="absolute bottom-8 animate-bounce cursor-pointer" @click="scrollToSection(1)">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-[#8A69E1]" fill="none" viewBox="0 0 24 24"
        stroke="currentColor">
  ...
  <section ref="section2"
    ...
    <transition name="fade-slide">
      <div v-if="sectionAnimations[1]" class="text-center md:text-left items-center font-bmjua flex flex-col">
    ...
    <!-- 오른쪽 이미지 -->
    <transition name="fade-slide">
      <img v-if="sectionAnimations[1]" src="@/assets/main_page/mapicon.png" alt="지도" class="w-[400px] mt-12" />
    </transition>
  ...
  <section ref="section3"
    ...
    <!-- 왼쪽 이미지 -->
    <transition name="fade-slide">
      <img v-if="sectionAnimations[2]" src="@/assets/main_page/piggy.png" alt="피그" class="w-[400px] mt-12" />
    </transition>
  ...
  <section ref="section4"
    ...
    <!-- 오른쪽 이미지 -->
    <transition name="fade-slide">
      <img v-if="sectionAnimations[3]" src="@/assets/main_page/video_icon.png" alt="스케줄"
  ...
  <section ref="section5"
    ...
    <!-- 왼쪽 이미지 -->
    <transition name="fade-slide">
      <img v-if="sectionAnimations[4]" src="@/assets/main_page/board.png" alt="게시판" class="w-[400px] mt-12" />
    </transition>
  ...
  <section ref="section6"
    ...
    <!-- 오른쪽 이미지 -->
    <transition name="fade-slide">
      <img v-if="sectionAnimations[5]" src="@/assets/main_page/gold.png" alt="금고" class="w-[300px] md:w-[400px]" />
    </transition>
    ...
    <transition name="fade-slide">
      <div v-if="sectionAnimations[6]" class="w-[300px] h-[300px] relative perspective-1000">
        <div class="bank_logos-rotator">
          <img v-for="(bank_logo, index) in bank_logos" :key="index" :src="bank_logo" class="bank_logos-img" />
        </div>
      </div>
    </transition>
